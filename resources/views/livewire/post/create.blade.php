<div
    class="block max-w-xl mt-8 mx-auto p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700" >
    <x-toast-alert/>
    <form class="max-w-xl mx-auto" wire:submit='store'>
